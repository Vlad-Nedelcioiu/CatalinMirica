...
## Corpus Check
- Corpus is ~20,076 words - fits in a single context window. You may not need a graph.

## Summary
- 284 nodes · 617 edges · 10 communities (8 shown, 2 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.89)
- Token cost: 82,550 input · 14,114 output
...
Cohesion: 0.09
Nodes (36): metadata, details, metadata, metadata, AboutTeaser(), highlights, CTASection(), featured (+28 more)

### Community 1 - "Design Docs & Critique"
Cohesion: 0.07
Nodes (44): Home Page Design Critique (24/40), P1: Conversion Hierarchy Inverts Documented Strategy, P1: Mobile Hero Grid Empty Holes, P1: Reduced-Motion Promise Not Kept / Opacity-0 Gating, P1: WCAG AA Contrast Failures on Brass and Muted Text, P2: Template Scaffolding (Eyebrow Saturation, Stat Band, Icon-Card Grid), Brass Accent Color Token (#a9743f), Ink Dark Background Color (#1b1916) (+36 more)
...
Cohesion: 0.10
Nodes (21): inter, metadata, playfair, viewport, aspectFor(), Filter, filters, Gallery() (+13 more)
...
## Knowledge Gaps
- **94 isolated node(s):** `metadata`, `statusTone`, `metadata`, `metadata`, `details` (+89 more)
...
- **Why does `cn()` connect `Booking Flow UI` to `Pages & Home Sections`, `Admin & Booking API`, `Layout, Gallery & Motion`?**
